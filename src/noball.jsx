    ...
    return(
      <>
           <div className="font-display italic text-3xl text-center text-green-500 mb-5 font-semibold mt-5">
                <h1>{bowl} VS {bat}</h1><br/>
                <h1>{bowl} Need {target} From {balls} Balls To Win </h1>
            </div>
            <br/>
            <h2 className="text-center text-3xl">{bowl} {chase}/{wicket} - {balls} Balls</h2>
            <div class="flex flex-wrap rounded-xl bg-gray-300 max-w-md mx-auto mt-20">
                ...
                <div class="w-1/2">
                    <button onClick={handleclick} value={0} class="w-full h-20 text-2xl text-gray-700 font-bold rounded-xl hover:bg-gray-400">DOT</button>
                </div>
                <div class="w-1/2">
                ...
                <div class="w-1/2">
                    <button  class="w-full h-20 text-2xl text-gray-700 font-bold rounded-xl hover:bg-gray-400">Noball</button>
                </div>
                <div class="w-1/2">
                    <button  value={1} class="w-full h-20 text-2xl text-gray-700 font-bold rounded-xl hover:bg-gray-400">Wide</button>
                </div>
        </div>
      </>
    );
